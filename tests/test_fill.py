...
import pytest
from xtrading_models import Execution, CommissionReport, Fill, Order, LimitOrder
...
def test_create_execution():
    ...
    assert execution.avgPrice == 150.25
...
def test_create_fill():
    ...
    assert fill.execution.price == 150.25
    assert fill.commissionReport.commission == 1.00
